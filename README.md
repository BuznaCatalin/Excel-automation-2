## Automated script that pick a column by your choice and sort the data from inside in n different files (depends on how many inputs are in the specific column).
## Example:
